          ...
          <div className={style.main}>
            ...
            <dl className="programlist">
              ...
              <dd>
                ...
                <br />
                <br /> Etter vigselen må ein på eigehand ta seg til festlokalet
            ...
            <p>
              ...
              og skriv inn Birkelunden som destinasjon. Det tek om lag 10 minutt
              med kollektivtransport frå Oslo S.
            </p>
            <h3>Til Solstua</h3>
            <p>
              Frå kyrkja til Voksenkollen tek det om lag ein time med
              kollektivtransport. Ta trikk nr. 12 (Majorstuen) eller 13
              (Bekkestua) frå Birkelunden. Gå av på Jerbanetorget.
            </p>{" "}
            <p>
              På Jerbanetorget byttar du til t-bane linje 1 mot Frognerseteren.
              Gå av på stoppet som heiter Voksenkollen
            </p>
            <p>
            ...
            <dl className="faq">
              <dt className="listheader">
                Kva gjer eg dersom eg vil underhalde?
              </dt>
              <dd>
                Ta kontakt med viseverten. Det er framleis uvisst kven dette er,
                men når me veit vil me skriva det her. Me set stor pris på
                underhalding.
              </dd>
              ...
              <dd>
                På e-post: sjurlur@gmail.com eller lisasmi@math.uio.no. På
                telefon: 992 29 275 (Sjur) eller 924 96 976 (Lisa)
              </dd>
            </dl>
          </div>
        </div>
